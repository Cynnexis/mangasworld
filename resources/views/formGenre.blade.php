	...
	<div class="form-horizontal">
			...
			<div class="col-md-3">
				<select class='form-control' name='cbScenariste' required>
					...
					@ foreach ($scenaristes as $scenariste)
						<option value="{$scenariste->id_scenariste}}"> {$scenariste->nom_scenariste}} </option>
					@ endforeach
				</select>
			</div>
		</div>
			...
			<div class="col-md-3">
				<select class='form-control' name='cbDessinateur' required>
					...
					@ foreach ($dessinateurs as $dessinateur)
						<option value="{$dessinateur->id_dessinateur}}"> {$dessinateur->nom_dessinateur}} </option>
					@ endforeach
				</select>
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-md-6">
				...
				<input type="hidden" name="couvertureHidden" value="/* A compléter */"/>
				<img src='/* A compléter */' class='img-responsive pull-right imgReduite' alt='/* A compléter */' />
			</div>
		</div>
		-->
		<div class="form-group">
